...
function p = ParseInput(varargin)
    ...
    p.addParameter('eye_movement_file', ...
        '/Users/jadz/Documents/Notebook/Matlab/Eye tracking Mice/Marcel De Jeu/Data/mouse1-HV', ...
        @(x) exist(x, 'file'));
    p.addParameter('eye_movement_startT', 110, @(x) x>0);
    p.addParameter('eye_movement_length', 1, @(x) x>0);
    ...
    p.addParameter('trials_per_block', 1, @(x) x>0);   
