...
% Texts
if Pass == 0
    % edited on 12/13/11 by P.J. to display "e-mail" instead of Login 
    gui.login_text = uicontrol(gui.main,'Style','text','FontSize',8,'HorizontalAlign','left','Units','characters','String','e-mail','Position',[1 7.65 20 1]);
end
...
% Edits
if Pass == 0
    % edited on 12/13/11 by P.J. to have my e-mail by default.
    gui.edit1 = uicontrol(gui.main,'Style','edit','FontSize',8,'HorizontalAlign','left','BackgroundColor','white','Units','characters','String','jadz@stanford.edu','Position',[1 6.02 33 1.7],'KeyPressfcn',{@Escape});
end
...
% edited on 12/13/11 by PJ to go streight into the password
uicontrol(gui.edit2)
